...
# --- Export DER ---
openssl x509 -in "${PK_DIR}/PK.pem" -outform DER -out "${PK_DIR}/PK.der"
openssl x509 -in "${KEK_DIR}/KEK.pem" -outform DER -out "${KEK_DIR}/KEK.der"
openssl x509 -in "${DB_DIR}/db.pem" -outform DER -out "${DB_DIR}/db.der"
